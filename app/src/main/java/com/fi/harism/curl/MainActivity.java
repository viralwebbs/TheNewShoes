 ...
 * @author harism
 */
public class MainActivity extends GLSurfaceView implements View.OnTouchListener,
        com.fi.harism.curl.CurlRenderer.Observer {
     ...
     * Default constructor.
     */
    public MainActivity(Context ctx, AttributeSet attrs) {
        super(ctx, attrs);
        init(ctx);
    }
     ...
     * Default constructor.
     */
    public MainActivity(Context ctx, AttributeSet attrs, int defStyle) {
        this(ctx, attrs);
    }
